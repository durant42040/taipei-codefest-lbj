        ...
        <CardContent className="flex gap-4 p-4">
          <div className="grid items-center gap-2">
            ...
            <div className="grid flex-1 auto-rows-min gap-0.5">
              ...
              <div className="flex items-baseline gap-1 text-xl text-[hsl(var(--chart-2))] font-bold tabular-nums leading-none">
                {burned}
                <span className="text-sm font-normal text-muted-foreground">
                  kcal
                </span>
            ...
            <div className="grid flex-1 auto-rows-min gap-0.5">
              ...
              <div className="flex items-baseline gap-1 text-xl text-[hsl(var(--chart-1))] font-bold tabular-nums leading-none">
                {time}
                <span className="text-sm font-normal text-muted-foreground">
                  hr
                </span>
